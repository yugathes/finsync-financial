...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setError(null);
    try {
      const { error }_ = await supabase.auth.signInWithPassword({ email, password });
